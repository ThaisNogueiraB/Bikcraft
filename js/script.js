...
if (window.SimpleForm) {
  new SimpleForm({
    fomr: ".formphp", //seletor do formulario
    ...
    sucesso: "div id='form-sucesso'><h2>Formulario enviado com sucesso</h2><p>Em breve eu entro em contato com você.</p></div>", //mensagem de sucesso 
  });
}